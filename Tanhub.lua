...
ImageButton.Image = "rbxassetid://16286995086"
...
--Create Tabs
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Auto Near Mobs", Default = false })
...
--Mastery
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Farm mastery trái", Default = false })
    ToggleMasteryFruit:OnChanged(function(Value)
        AutoFarmMasDevilFruit = Value
    end)
    Options.ToggleMasteryFruit:SetValue(false)

    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Farm mastery súng", Default = false })
...
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Farm xương", Default = false })
...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Farm vật chất kì dị", Default = false })
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Đánh Boss", Default = false })
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Farm nguyên liệu", Default = false })
...
if Third_Sea then
    ...
    local ToggleBoat = Tabs.Main:AddToggle("ToggleBoat", {Title = "Mua thuyền", Default = false })
   ...
   local ToggleTW = Tabs.Main:AddToggle("ToggleTW", {Title = "Tự động chạy thẳng", Default = false })
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Đánh Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = "Đánh Piranha", Default = false })
     ...
     Tabs.Main:AddParagraph({
        Title = "Elite Hunter",
        Content = "Tự động nhận nhiệm vụ và đánh Elite"
    })


    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Đánh Elite", Default = false })
...
if Third_Sea then
       ...
       Tabs.Main:AddParagraph({
        Title = "Sea Beast",
        Content = "Đánh Sea Beast"
    })


local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Đánh Seabeast", Default = false })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Tự động chạy thẳng", Default = false })
ToggleAutoW:OnChanged(function(Value)
 ...
 Tabs.Main:AddParagraph({
    Title = "Đảo Bí Ẩn",
    Content = "Tìm đảo bí ẩn"
})



local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tìm đảo bí ẩn", Default = false })
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Tự động chạy thẳng", Default = false })
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
    ...
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Lấy lưỡi hái[Tự động]", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Lấy Yama", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Lấy Tushita", Default = false })
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Tự động farm Factory", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Xóa dame", Default = true })
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Tăng melee", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Tăng phòng thủ", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Tăng kiếm", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Tăng súng", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Tăng trái ác quỷ", Default = false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Teleport tới người chơi", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Mua Trái", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Lưu trữ trái ác quỷ", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Random trái ác quỷ", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Lụm trái ác quỷ", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Định vị trái ác quỷ", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "Định vị bông hoa(nâng tộc v2)", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Bắt đầu tập kích", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Tự động giết", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto thức tỉnh", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Lấy fruit ít beli", Default = false })
